...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <PageWrapper>
          <Routes>
            <Route path="/cat_pinterest" element={<MainPage catsData={cats} addToFavorite={addToFavorite} removeFromFavorite={removeFromFavorite}/>}/>
            <Route path="/favorites" element={<Favorites catsData={favoriteCats} addToFavorite={addToFavorite} removeFromFavorite={removeFromFavorite}/>}/>
          </Routes>
      </PageWrapper>
    </BrowserRouter>
  );
